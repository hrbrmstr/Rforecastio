---
title: "Rforecastio Package Update (1.2.0)"
...
```{r hourly, fig.width=6, fig.height=3, fig.cap="hourly", fig.retina=TRUE, fig.subcap="Hourly"}
...
```{r daily, fig.width=6, fig.height=3, fig.cap="daily", fig.retina=TRUE, fig.subcap="Daily"}
